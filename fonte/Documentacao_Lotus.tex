...
Comentários são marcados com ``-{}-'', assim como o ``//'' do C ou Java. Não há comentários de bloco.\\[0.3cm]
...
let var@: int; -{}-(não é permitido o uso de caracteres especiais)\\[0.3cm]
