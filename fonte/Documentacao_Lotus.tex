...
\item \hyperlink{label}{Sintaxe}
\item \hyperlink{label}{Extensão de arquivos}\\[15.4cm]
\end{itemize}
...
\hypertarget{label}{\Large{Extensão de arquivos}}\\[0.3cm]
\normalsize

Os códigos escritos com a linguagem de programação Lotus devem apresentar extensão ``.lt''.

\hypertarget{label}{\Large{Sintaxe}}\\[0.3cm]
\normalsize
